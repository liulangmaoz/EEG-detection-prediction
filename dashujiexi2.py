...
# ====================== 参数 ======================
SEGMENT_DIR = r"D:\python\pythonProject\EEG_CNN-LSTM\segmented_dataset"
EPILEPSY_DIR = os.path.join(SEGMENT_DIR, "epilepsy_segments")
NORMAL_DIR = os.path.join(SEGMENT_DIR, "normal_segments")
...
# ====================== 数据加载 ======================
X_neg = load_all_segments(NORMAL_DIR, "正常", max_count=28)
X_pos = load_all_segments(EPILEPSY_DIR, "癫痫", max_count=28)
